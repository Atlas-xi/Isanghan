...
public:
    ...
    bool Inactive(timing_clock::duration _duration, bool canChangeState);
    bool Untargetable(timing_clock::duration _duration, bool canChangeState); // Used to make owner entity untargetable & inactionable in TargetFind for _duration
    ...
    timing_clock::time_point getTick();
    timing_clock::time_point getPrevTick();
...
protected:
    ...
    timing_clock::time_point m_PrevTick;
