...
CInactiveState::CInactiveState(CBaseEntity* PEntity, timing_clock::duration _duration, bool canChangeState, bool untargetable)
: CState(PEntity, 0)
...
bool CInactiveState::Update(timing_clock::time_point tick)
{
...
void CInactiveState::Cleanup(timing_clock::time_point tick)
{
}
