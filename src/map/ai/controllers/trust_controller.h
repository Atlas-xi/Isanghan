...
public:
    ...
    void Tick(timing_clock::time_point) override;
...
private:
    void DoCombatTick(timing_clock::time_point tick) override;
    void DoRoamTick(timing_clock::time_point tick) override;
