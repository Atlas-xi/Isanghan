...
void CPlayerCharmController::Tick(timing_clock::time_point tick)
{
    m_Tick = tick;
...
void CPlayerCharmController::DoCombatTick(timing_clock::time_point tick)
{
...
void CPlayerCharmController::DoRoamTick(timing_clock::time_point tick)
{
    if (POwner->PMaster->PAI->IsEngaged())
    {
