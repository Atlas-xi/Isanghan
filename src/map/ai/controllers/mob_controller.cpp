...
void CMobController::Tick(timing_clock::time_point tick)
{
    TracyZoneScoped;
...
void CMobController::DoCombatTick(timing_clock::time_point tick)
{
...
void CMobController::DoRoamTick(timing_clock::time_point tick)
{
    ...
    // TODO
    else if (PMob->GetDespawnTime() > timing_clock::time_point::min() && PMob->GetDespawnTime() < m_Tick)
    {
        Despawn();
        return;
    }
...
void CMobController::Wait(timing_clock::duration _duration)
{
    if (m_Tick > m_WaitTime)
    {
