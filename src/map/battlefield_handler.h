...
public:
    ...
    void          HandleBattlefields(timing_clock::time_point tick);                                              // called every tick to handle win/lose conditions, locking the bcnm, etc
...
private:
    ...
    std::vector<std::pair<uint32, timing_clock::time_point>> m_orphanedPlayers;
};
